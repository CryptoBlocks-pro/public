...
while true; do
    ...
    echo "Press U or u to update Docker image."
    echo "Press R or r to pull tip and restart Watcher."
    echo "Press D or d to remove Postgres database."
    ...
    case "$next_action" in
        ...
        c)
            ...
            ;;
        *)
            echo "Invalid option. Please enter U/u, R/r, D/d, or C/c."
            ;;
    esac
done
